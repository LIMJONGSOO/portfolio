...
const ProjectDatas = [
  ...
  },
  {
    ...
    skills: [angular, typescript, html, less, git, swagger],
  },
  {
    ...
    skills: [spring, maven, javascript, jsp, jquery, html, css, oracle, svn],
  },
  {
  ...
  },
  {
    ...
    endDate: "2019.02",
    projectDesc:
      "아시아나 항공의 IUP 부가서비스 판매기능 개발 (IUP-좌석업그레이드)",
    myTasklist: [
  ...
  },
  {
    ...
    endDate: "2018.08",
    projectDesc:
      "아시아나항공 홈페이지 개편, 예매/부가 서비스 고도화, PC,모바일 WEB, APP 평균 30%의 속도 향상 및 안정성 개선",
    myTasklist: [
  ...
  },
  {
    ...
    endDate: "2017.02",
    projectDesc:
      "오프라인으로 작업하던 이륙성능자료 관리를 온라인화, 이륙성능자료 계산 속도와 정확성 향상",
    myTasklist: [
  ...
  },
  {
    ...
    endDate: "2016.02",
    projectDesc:
      "아시아나항공 홈페이지 미국 장애인차별금지법에 준수하는 웹 접근성을 제공하도록 개편",
    myTasklist: ["장차법에 준수하는 웹 접근성을 제공하도록 웹 페이지 수정"],
    skills: [spring, maven, javascript, jsp, jquery, html, css, oracle, svn],
  },
  {
    ...
    endDate: "2015.06",
    projectDesc:
      "제주항공 기업회원을 추가, 기업별로 할인혜택을 제공하는 서비스 구축, 기업우대 서비스 관리자 페이지 구축",
    myTasklist: ["기업회원 관리하는 웹 페이지 개발(사내시스템)"],
    skills: [spring, maven, javascript, jsp, jquery, html, css, db2, svn],
  },
  {
    ...
    endDate: "2015.03",
    projectDesc:
      "제주항공 여행사우대사이트에서 AUTH(여행사에서 운임규정 관련 요청) 신청 서비스 구현, AUTH 관리자 서비스 구현",
    myTasklist: ["데이터(AUTH)를 조회하는 관리자 웹 페이지 개발"],
    skills: [spring, maven, javascript, jsp, jquery, html, css, db2, svn],
  },
  {
  ...
  },
  {
    ...
    endDate: "2013.12",
    projectDesc:
      "압력센서를 장착한 스마트 슈즈 제작, 압력정보로 걸음걸이를 분석하는 앱(WalkChecker) 개발",
    myTasklist: [
