...
class Projects extends Component<projectProps, projectState> {
  ...
  foldProject = () => {
    this.setState({
      projectFold: !this.state.projectFold,
      foldButtonImg: this.state.projectFold ? fold : unfold,
    });
  };
              ...
              <table className="project-list-table">
                ...
                <tbody>
                  <tr className="project-title">
                    <td
                      rowSpan={
                        this.state.projectFold
                          ? 5
                          : this.state.projectList.length + 2
                      }
                      className="graph"
                    >
